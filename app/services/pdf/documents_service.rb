...
class Pdf::DocumentsService
  ...
  private
    ...
    def contract_work_sections
      [
        ...
        [ "5. ПОРЯДОК СДАЧИ И ПРИЕМКИ РАБОТ", [
          ...
          "5.4. В случае, если Заказчик уклоняется от подписания Акта выполненных работ в течении 2 (двух) рабочих дней без обоснованных замечаний к выполненным работам, работы считаются выполненными надлежащим образом, принятыми Заказчиком в полном объеме и подлежат оплате на основании односторонне составленного Акта выполненных работ."
        ] ],
    ...
    def contract_supply_sections
      [
        [ "1. Предмет договора", [
          "1.1. В соответствии с настоящим Договором Поставщик обязуется поставить Покупателю комплект оборудования (далее — Продукция) в соответствии с Заказом покупателя, который является неотъемлемой частью настоящего договора, а Покупатель принять и оплатить продукцию в соответствии с разделом 2 договора."
        ] ],
